...
How to Install and Run this Program? Simply download the file, and run it in a terminal or a compiler which supports Java and has the necessary prerequisites like JDK and Java C. In our case, we used Visual Studio Code running on Windows 11 with the latest version of Oracle's Java SE 21. We also tested this on some online compilers like onlinegdb.com/online_java_compiler and Programiz.
...
Credits I developed this along with my teammate ANITEJ MISHRA, my friends and colleagues at SRM IST Chennai.
